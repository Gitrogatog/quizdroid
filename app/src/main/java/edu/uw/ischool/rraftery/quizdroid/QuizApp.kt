...
class QuizApp : Application() {
    val state = TopicState(HardcodedQuizSet().getHardcodedTopicSet())
...
class HardcodedQuizSet(){
    var MathQuiz : Topic = Topic("Math", "Test your computation skills against this set of math problems!", arrayOf<Quiz>(
    ...
    var PhysicsQuiz : Topic = Topic("Physics", "See how you measure up with this Physics quiz!", arrayOf<Quiz>(
    ...
    var MarvelQuiz : Topic = Topic("Marvel", "Hope you read the Marvel comics, because none of these are in the movies!", arrayOf<Quiz>(
    ...
    var PokemonQuiz : Topic = Topic("Pokemon", "How many of these little gremlins do you know?", arrayOf<Quiz>(
